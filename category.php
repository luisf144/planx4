    ...
    <div class="container">
       ...
       <ul class="pager">
            ...
            for($i = 1; $i <= $all_posts_count; $i++){
                if($current_page == $i)
                    echo "<li> <a href='category.php?category_id={$post_category_id}&page={$i}' class='page-selected'> {$i} </a> </li>";
                else
                    echo "<li> <a href='category.php?category_id={$post_category_id}&page={$i}'> {$i} </a> </li>";
            }
